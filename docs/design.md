...
|---|---|---|
| Unpinned silent crosstalk | Fixed upstream, **live-confirmed**: 2+ editors and no pin → hard error naming the instances; 1 editor → auto-select. | **None (zero code).** Retire the standing context anyway. |
